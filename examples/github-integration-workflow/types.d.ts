...
declare module 'motia' {
  ...
  type Handlers = {
    'PR Webhook Handler': ApiRouteHandler<{ action: string; pull_request: { number: number; title: string; body?: string; state: string; labels: { name: string }[]; user: { login: string }; base: { ref: string; repo: { name: string; owner: { login: string } } }; head: { ref: string; sha: string } } }, unknown, { topic: 'github.pr.opened'; data: never } | { topic: 'github.pr.edited'; data: { prNumber: number; owner: string; repo: string; commitSha: string } }>
    'PR Test Monitor': EventHandler<{ prNumber: number; owner: string; repo: string; commitSha: string }, never>
    ...
    'GitHub Webhook Handler': ApiRouteHandler<{ action: string; issue: { number: number; title: string; body?: string; state: string; labels: { name: string }[] }; repository: { owner: { login: string }; name: string } }, unknown, { topic: 'github.issue.opened'; data: { issueNumber: number; title: string; body?: string; owner: string; repo: string } } | { topic: 'github.issue.edited'; data: { issueNumber: number; title: string; body?: string; owner: string; repo: string } } | { topic: 'github.issue.closed'; data: { issueNumber: number; owner: string; repo: string } }>
