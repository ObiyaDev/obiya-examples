...
class Issue(BaseModel):
    ...
    grounds: str = Field(..., description="Evidence supporting the claim")
    warrant: str = Field(..., description="Reasoning connecting grounds to claim")
    backing: str = Field(..., description="Support for the warrant")
    qualifier: str = Field(..., description="Conditions or limits on the claim")
...
class Evaluation(BaseModel):
    ...
    issueSummary: str = Field(..., description="Summary of identified issues")
...
class Commits:
    ...
    async def create(cls, trace_id: str, state: any, input_data: dict) -> 'Commits':
        # This will be implemented when we need repository integration
        raise NotImplementedError("Repository integration not implemented yet")
